...
*/
    ...
    public void init() {
        ...
        if (isKnight) {
            ...
            for (int i = 0; i < 4; i++) {
                try {
                    knightRightImage[i] = ImageIO.read(ClassLoader.getSystemResource("sprites/knight/" + (i + 1) + ".png"));
                } catch (IOException e) {
            ...
            for (int i = 0; i < 4; i++) {
                try {
                    knightUpImage[i] = ImageIO.read(ClassLoader.getSystemResource("sprites/knight/" + (i + 5) + ".png"));
                } catch (IOException e) {
                    System.out.println("IOException");
                }
            }
            for (int i = 0; i < 4; i++) {
                try {
                    knightDownImage[i] = ImageIO.read(ClassLoader.getSystemResource("sprites/knight/" + (i + 9) + ".png"));
                } catch (IOException e) {
                    System.out.println("IOException");
                }
            }
            for (int i = 0; i < 4; i++) {
                try {
                    knightLeftImage[i] = ImageIO.read(ClassLoader.getSystemResource("sprites/knight/" + (i + 13) + ".png"));
                } catch (IOException e) {
                    System.out.println("IOException");
                }
            }
            ...
            for (int i = 0; i < 6; i++) {
                try {
                    duncanRightImage[i] = ImageIO.read(ClassLoader.getSystemResource("sprites/duncanright" + (i + 1) + ".png"));
                } catch (IOException e) {
                    System.out.println("IOException");
                }
            }
            for (int i = 0; i < 6; i++) {
                try {
                    duncanUpImage[i] = ImageIO.read(ClassLoader.getSystemResource("sprites/duncanback" + (i + 1) + ".png"));
                } catch (IOException e) {
                    System.out.println("IOException");
                }
            }
            for (int i = 0; i < 6; i++) {
                try {
                    duncanDownImage[i] = ImageIO.read(ClassLoader.getSystemResource("sprites/duncanfront" + (i + 1) + ".png"));
                } catch (IOException e) {
                    System.out.println("IOException");
                }
            }
            for (int i = 0; i < 6; i++) {
                try {
                    duncanLeftImage[i] = ImageIO.read(ClassLoader.getSystemResource("sprites/duncanleft" + (i + 1) + ".png"));
                } catch (IOException e) {
                    System.out.println("IOException");
                }
            }
            ...
            for (int i = 0; i < 6; i++) {
                try {
                    banquoRightImage[i] = ImageIO.read(ClassLoader.getSystemResource("sprites/banquoright" + (i + 1) + ".png"));
                } catch (IOException e) {
                    System.out.println("IOException");
                }
            }
            for (int i = 0; i < 6; i++) {
                try {
                    banquoUpImage[i] = ImageIO.read(ClassLoader.getSystemResource("sprites/banquoback" + (i + 1) + ".png"));
                } catch (IOException e) {
                    System.out.println("IOException");
                }
            }
            for (int i = 0; i < 6; i++) {
                try {
                    banquoDownImage[i] = ImageIO.read(ClassLoader.getSystemResource("sprites/banquofront" + (i + 1) + ".png"));
                } catch (IOException e) {
                    System.out.println("IOException");
                }
            }
            for (int i = 0; i < 6; i++) {
                try {
                    banquoLeftImage[i] = ImageIO.read(ClassLoader.getSystemResource("sprites/banquoleft" + (i + 1) + ".png"));
                } catch (IOException e) {
                    System.out.println("IOException");
                }
            }
            ...
            try {
                banquoGhost = ImageIO.read(ClassLoader.getSystemResource("sprites/banquoghostfront1.png"));
            } catch (IOException e) {
                System.out.println("IOException");
            ...
            for (int i = 0; i < 6; i++) {
                try {
                    ladyMacduffRightImage[i] = ImageIO.read(ClassLoader.getSystemResource("sprites/ladymacduffright" + (i + 1) + ".png"));
                } catch (IOException e) {
                    System.out.println("IOException");
                }
            }
            for (int i = 0; i < 6; i++) {
                try {
                    ladyMacduffUpImage[i] = ImageIO.read(ClassLoader.getSystemResource("sprites/ladymacduffback" + (i + 1) + ".png"));
                } catch (IOException e) {
                    System.out.println("IOException");
                }
            }
            for (int i = 0; i < 6; i++) {
                try {
                    ladyMacduffDownImage[i] = ImageIO.read(ClassLoader.getSystemResource("sprites/ladymacdufffront" + (i + 1) + ".png"));
                } catch (IOException e) {
                    System.out.println("IOException");
                }
            }
            for (int i = 0; i < 6; i++) {
                try {
                    ladyMacduffLeftImage[i] = ImageIO.read(ClassLoader.getSystemResource("sprites/ladymacduffleft" + (i + 1) + ".png"));
                } catch (IOException e) {
                    System.out.println("IOException");
                }
            }
            ...
            for (int i = 0; i < 6; i++) {
                try {
                    macduffSonRightImage[i] = ImageIO.read(ClassLoader.getSystemResource("sprites/macduffsonright" + (i + 1) + ".png"));
                } catch (IOException e) {
                    System.out.println("IOException");
                }
            }
            for (int i = 0; i < 6; i++) {
                try {
                    macduffSonUpImage[i] = ImageIO.read(ClassLoader.getSystemResource("sprites/macduffsonback" + (i + 1) + ".png"));
                } catch (IOException e) {
                    System.out.println("IOException");
                }
            }
            for (int i = 0; i < 6; i++) {
                try {
                    macduffSonDownImage[i] = ImageIO.read(ClassLoader.getSystemResource("sprites/macduffsonfront" + (i + 1) + ".png"));
                } catch (IOException e) {
                    System.out.println("IOException");
                }
            }
            for (int i = 0; i < 6; i++) {
                try {
                    macduffSonLeftImage[i] = ImageIO.read(ClassLoader.getSystemResource("sprites/macduffsonleft" + (i + 1) + ".png"));
                } catch (IOException e) {
                    System.out.println("IOException");
                }
            }
            ...
            for (int i = 0; i < 6; i++) {
                try {
                    youngSiwardRightImage[i] = ImageIO.read(ClassLoader.getSystemResource("sprites/youngsiwardright" + (i + 1) + ".png"));
                } catch (IOException e) {
                    System.out.println("IOException");
                }
            }
            for (int i = 0; i < 6; i++) {
                try {
                    youngSiwardUpImage[i] = ImageIO.read(ClassLoader.getSystemResource("sprites/youngsiwardback" + (i + 1) + ".png"));
                } catch (IOException e) {
                    System.out.println("IOException");
                }
            }
            for (int i = 0; i < 6; i++) {
                try {
                    youngSiwardDownImage[i] = ImageIO.read(ClassLoader.getSystemResource("sprites/youngsiwardfront" + (i + 1) + ".png"));
                } catch (IOException e) {
                    System.out.println("IOException");
                }
            }
            for (int i = 0; i < 6; i++) {
                try {
                    youngSiwardLeftImage[i] = ImageIO.read(ClassLoader.getSystemResource("sprites/youngsiwardleft" + (i + 1) + ".png"));
                } catch (IOException e) {
                    System.out.println("IOException");
                }
            }
            ...
            for (int i = 0; i < 6; i++) {
                try {
                    macduffRightImage[i] = ImageIO.read(ClassLoader.getSystemResource("sprites/macduffright" + (i + 1) + ".png"));
                } catch (IOException e) {
                    System.out.println("IOException");
                }
            }
            for (int i = 0; i < 6; i++) {
                try {
                    macduffUpImage[i] = ImageIO.read(ClassLoader.getSystemResource("sprites/macduffback" + (i + 1) + ".png"));
                } catch (IOException e) {
                    System.out.println("IOException");
                }
            }
            for (int i = 0; i < 6; i++) {
                try {
                    macduffDownImage[i] = ImageIO.read(ClassLoader.getSystemResource("sprites/macdufffront" + (i + 1) + ".png"));
                } catch (IOException e) {
                    System.out.println("IOException");
                }
            }
            for (int i = 0; i < 6; i++) {
                try {
                    macduffLeftImage[i] = ImageIO.read(ClassLoader.getSystemResource("sprites/macduffleft" + (i + 1) + ".png"));
                } catch (IOException e) {
                    System.out.println("IOException");
                }
            }
            ...
            for (int i = 0; i < 6; i++) {
                try {
                    ladyMacbethRightImage[i] = ImageIO.read(ClassLoader.getSystemResource("sprites/ladymacbethright" + (i + 1) + ".png"));
                } catch (IOException e) {
                    System.out.println("IOException");
                }
            }
            for (int i = 0; i < 6; i++) {
                try {
                    ladyMacbethUpImage[i] = ImageIO.read(ClassLoader.getSystemResource("sprites/ladymacbethback" + (i + 1) + ".png"));
                } catch (IOException e) {
                    System.out.println("IOException");
                }
            }
            for (int i = 0; i < 6; i++) {
                try {
                    ladyMacbethDownImage[i] = ImageIO.read(ClassLoader.getSystemResource("sprites/ladymacbethfront" + (i + 1) + ".png"));
                } catch (IOException e) {
                    System.out.println("IOException");
                }
            }
            for (int i = 0; i < 6; i++) {
                try {
                    ladyMacbethLeftImage[i] = ImageIO.read(ClassLoader.getSystemResource("sprites/ladymacbethleft" + (i + 1) + ".png"));
                } catch (IOException e) {
                    System.out.println("IOException");
                }
            }
            ...
            try {
                witch1 = ImageIO.read(ClassLoader.getSystemResource("sprites/witch1.png"));
            } catch (IOException e) {
                System.out.println("IOException");

            }
            try {
                witch2 = ImageIO.read(ClassLoader.getSystemResource("sprites/witch2.png"));
            } catch (IOException e) {
                System.out.println("IOException");

            }
            try {
                witch3 = ImageIO.read(ClassLoader.getSystemResource("sprites/witch3.png"));
            } catch (IOException e) {
                System.out.println("IOException");
