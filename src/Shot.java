...
public class Shot {
    ...
    public Shot(Player player, double x, double y) {
        ...
        this.radius = 4;
        try {
            this.swordUp = ImageIO.read(ClassLoader.getSystemResource("sprites/shot/swordup.png"));
        } catch (IOException e) {
            System.out.println("IOException");
        } // catch
        try {
            this.swordDown= ImageIO.read(ClassLoader.getSystemResource("sprites/shot/sworddown.png"));
        } catch (IOException e) {
            System.out.println("IOException");
        } // catch
        try {
            this.swordRight = ImageIO.read(ClassLoader.getSystemResource("sprites/shot/swordright.png"));
        } catch (IOException e) {
            System.out.println("IOException");
        } // catch
        try {
            this.swordLeft= ImageIO.read(ClassLoader.getSystemResource("sprites/shot/swordleft.png"));
        } catch (IOException e) {
            System.out.println("IOException");
        } // catch
    } // Shot
