...
public class TileMap {
	...
	public void draw(Graphics2D g) {
		...
		while (counter == 0) {
			try {
				tile = ImageIO.read(ClassLoader.getSystemResource("sprites/tile.png"));
			} catch (IOException e) {
				System.out.println("IOException");
			}

			try {
				floor = ImageIO.read(ClassLoader.getSystemResource("sprites/brick.png"));
			} catch (IOException e) {
				System.out.println("IOException");
			}

			try {
				door1 = ImageIO.read(ClassLoader.getSystemResource("sprites/door1.png"));
			} catch (IOException e) {
				System.out.println("IOException");
			}
			try {
				door2 = ImageIO.read(ClassLoader.getSystemResource("sprites/door2.png"));
			} catch (IOException e) {
				System.out.println("IOException");
			}
			try {
				door3 = ImageIO.read(ClassLoader.getSystemResource("sprites/door3.png"));
			} catch (IOException e) {
				System.out.println("IOException");
			}
			try {
				door4 = ImageIO.read(ClassLoader.getSystemResource("sprites/door4.png"));
			} catch (IOException e) {
				System.out.println("IOException");
			}
			try {
				grass = ImageIO.read(ClassLoader.getSystemResource("sprites/grass.png"));
			} catch (IOException e) {
				System.out.println("IOException");
			}
			try {
				tree = ImageIO.read(ClassLoader.getSystemResource("sprites/tree.png"));
			} catch (IOException e) {
				System.out.println("IOException");
			}
			try {
				castlefloor = ImageIO.read(ClassLoader.getSystemResource("sprites/castlefloor.png"));
			} catch (IOException e) {
				System.out.println("IOException");
			}
			try {
				castlewall = ImageIO.read(ClassLoader.getSystemResource("sprites/castlewall.png"));
			} catch (IOException e) {
				System.out.println("IOException");
			}
			try {
				darkGrass = ImageIO.read(ClassLoader.getSystemResource("sprites/darkgrass.png"));
			} catch (IOException e) {
				System.out.println("IOException");
			}
			try {
				darkTree = ImageIO.read(ClassLoader.getSystemResource("sprites/darktree.png"));
			} catch (IOException e) {
				System.out.println("IOException");
			}
			counter++;
