...
//		System.out.println("wtfff");
		if (waitingForKeypress) {
			try {
				title = ImageIO.read(ClassLoader.getSystemResource("sprites/title.png"));
			} catch (IOException e) {
		...
		if (waitingForKeypress2 && !waitingForKeypress) {
			try {
				title = ImageIO.read(ClassLoader.getSystemResource("sprites/instructions.png"));
			} catch (IOException e) {
				System.out.println("IOException");
			}
		...
		if (showCredits) {
			try {
				title = ImageIO.read(ClassLoader.getSystemResource("sprites/credits.png"));
			} catch (IOException e) {
				System.out.println("IOException");
			}
